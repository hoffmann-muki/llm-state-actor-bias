...
dataset_dir = os.path.join('datasets', 'nga')
os.makedirs(dataset_dir, exist_ok=True)
out_country = os.path.join(dataset_dir, "Nigeria_lagged_data_up_to-2024-10-24.csv")
...
cols_lower = {c.lower(): c for c in df_nga.columns}
...
SAMPLE_DIR = os.path.join('datasets', 'nga')
os.makedirs(SAMPLE_DIR, exist_ok=True)
SAMPLE_PATH = os.path.join(SAMPLE_DIR, "state_actor_sample_nga.csv")
